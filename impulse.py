...
def swing():
    ...
    tip_top = helix(const = 1, len = 10, pos = fixed_tip.pos, radius = .5, thickness = .1, coils = 10, color = color.yellow)
    top_bot = helix(const = 1, len = 10, radius = .5, thickness = .1, coils = 10, color = color.cyan)
